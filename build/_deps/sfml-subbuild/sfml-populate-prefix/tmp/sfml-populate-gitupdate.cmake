...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" show-ref 2.6.x
  WORKING_DIRECTORY "C:/Users/Халил/Desktop/VSProjects/Tetris/Tetris/build/_deps/sfml-src"
...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" rev-list --max-count=1 2.6.x
  WORKING_DIRECTORY "C:/Users/Халил/Desktop/VSProjects/Tetris/Tetris/build/_deps/sfml-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Халил/Desktop/VSProjects/Tetris/Tetris/build/_deps/sfml-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Халил/Desktop/VSProjects/Tetris/Tetris/build/_deps/sfml-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
